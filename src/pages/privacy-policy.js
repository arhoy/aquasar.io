...
const PrivacyPolicyPage = () => {
  return (
    <Layout>
      <CustomP>
        Aquasar Inc Privacy Policy This Privacy Policy describes how your
        personal information is collected, used, and shared when you visit or
        make a purchase from https://aquasar.io (the “Site”). PERSONAL
      ...
      <CustomP>
        ...
        “Device Information.” We collect Device Information using the following
        technologies: - “Cookies” are data files that are placed on your device
      ...
      <CustomP>
        ...
        described above. For example, we also use Google Analytics to help us
      ...
      <CustomP>
        ...
        You can opt out of targeted advertising by: Additionally, you can opt
        ...
        practices when we see a Do Not Track signal from your browser. YOUR
